...
import '../../core/models/movies_modal.dart';

class DetailsPage extends StatelessWidget {
 const DetailsPage({super.key, required this.movie, required this.moreLikeThis});
 final MoviesModal movie;
 final List<MoviesModal> moreLikeThis;
  @override
